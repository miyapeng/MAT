#!/bin/bash
#SBATCH --job-name=gaia_minicpm  # create a short name for your job
...
# agent_tune_dataset_gaia_57k_20241210.json this upsample new data x 5
# agent_tune_dataset_gaia_25k_20241210.json this not upsample old data
DATA="data/agent_tune_dataset_gaia_57k_20241210.json"
LLM_TYPE="qwen2" 
