...
CUDA_VISIBLE_DEVICES=5 python examples/gaia/main.py --engine minicpm --lora-path experiments/CPM-FT/output/cpm_v2_6_7897482_2024_11_10_09_38/ --data-name 2023_level1 --split validation > eval_settings2.log 2>&1 &

CUDA_VISIBLE_DEVICES=0 python examples/gaia/main.py --engine minicpm --lora-path experiments/CPM-FT/output/cpm_v2_6_7897482_2024_11_10_09_38/ --data-name 2023_level3 --split validation > eval_settings2_lv3.log 2>&1 &
# CUDA_VISIBLE_DEVICES=4 python examples/gaia/main.py --engine minicpm --lora-path experiments/CPM-FT/output/cpm_v2_6_7897481_2024_11_10_07_40/ --data-name 2023_level1 --split validation
