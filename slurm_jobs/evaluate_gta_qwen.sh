...
# python examples/gta/main.py --engine minicpm --lora-path experiments/CPM-FT/output/cpm_v2_6_7879846_2024_09_30_14_34
python examples/gta/main.py --engine qwen --lora-path output_qwen/Qwen2-VL-7B-Instruct-7899951

# python examples/gta/main.py --engine qwen