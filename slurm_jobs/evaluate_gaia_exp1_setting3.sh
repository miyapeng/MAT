...
python examples/gaia/main.py --engine minicpm --lora-path experiments/CPM-FT/output/cpm_v2_6_7897483_2024_11_10_09_41/ --data-name 2023_level2 --split validation


# CUDA_VISIBLE_DEVICES=2 python examples/gaia/main.py --engine minicpm --lora-path experiments/CPM-FT/output/cpm_v2_6_7897483_2024_11_10_09_41/ --data-name 2023_level3 --split validation > eval_settings3_lv3.log 2>&1 &
